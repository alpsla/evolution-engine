"""
Calibration Run: evolution-engine (meta-calibration)

Runs the full pipeline (Phase 1-5) on the evolution-engine repository itself.
"""
...
REPO_NAME = "evolution-engine"
REPO_PATH = Path(__file__).parent.parent  # The repo itself
...
phase2 = Phase2Engine(RUN_DIR, min_baseline=5)
...
print(f"\nReports:")
print(f"  Advisory: {RUN_DIR}/phase5/advisory.json")
print(f"  Summary: {RUN_DIR}/phase5/summary.txt")
print(f"  Chat: {RUN_DIR}/phase5/chat.txt")
print(f"  Investigation: {RUN_DIR}/phase5/investigation_prompt.txt")
