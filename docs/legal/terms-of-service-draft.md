...
>
> This document is a starting template prepared for legal counsel review. It is not a finalized Terms of Service agreement and should not be published or relied upon as legal advice. A qualified attorney should review, revise, and approve this document before publication.
...
### 3.2 Pro Tier
The Pro tier is available for **$19 per month** (USD), billed monthly via Stripe. The Pro tier includes all Free tier features plus additional capabilities such as AI-powered investigation, automated fix suggestions, and other features as described on the codequal.dev website.

[LAWYER NOTE: Confirm the feature breakdown between tiers before publishing. Features may change; consider whether to enumerate them here or reference a separate pricing page.]
...
- Download and install the Evolution Engine CLI on your devices
- Use the Service for your internal business or personal software development purposes
- Use the output generated by the Service (reports, advisories, patterns) without restriction

### 4.2 Free Tier License
The Free tier license permits use by individual developers and teams at no cost, subject to the restrictions in Section 5.

### 4.3 Pro Tier License
The Pro tier license extends the Free tier license with access to additional features for the duration of your active subscription. The license is granted to the individual or organization associated with the license key.
...
- Reverse engineer, decompile, disassemble, or attempt to derive the source code of any compiled or obfuscated components of the Service, including but not limited to Cython-compiled modules (`.so`, `.pyd`, `.dylib` files)
...
If you opt in to Knowledge Base sync (privacy level 1 or 2), the anonymized patterns you contribute to the community registry are licensed under [SPECIFY LICENSE -- suggest: Creative Commons CC0 or CC-BY-4.0] for use by all community members. You acknowledge that contributed patterns cannot be recalled once shared, though you can stop contributing at any time.
...
[LAWYER NOTE: Verify that these limitation of liability provisions comply with applicable consumer protection laws in target jurisdictions.]
...
[LAWYER NOTE: Consider implementing a self-service cancellation mechanism and referencing it here.]
...
These Terms shall be governed by and construed in accordance with the laws of the State of [SPECIFY STATE], United States, without regard to its conflict of law principles.

[LAWYER NOTE: Choose a governing law jurisdiction. Common choices include Delaware (business-friendly), California (if company is based there), or New York. Consider the implications for consumer protection requirements in the chosen jurisdiction and in jurisdictions where users are located (e.g., EU consumer protection directives).]
...
If the dispute cannot be resolved informally, you and CodeQual agree to resolve any dispute, claim, or controversy arising out of or relating to these Terms or the Service through binding arbitration administered by [SPECIFY ARBITRATION BODY -- e.g., the American Arbitration Association (AAA)] under its [Consumer/Commercial] Arbitration Rules. The arbitration will be conducted in [SPECIFY LOCATION] or remotely, at the election of the party initiating the arbitration.
...
### 14.5 Opt-Out
You may opt out of the arbitration and class action waiver provisions by sending written notice to info@codequal.dev within 30 days of first accepting these Terms. If you opt out, disputes will be resolved in the state or federal courts located in [SPECIFY JURISDICTION].

[LAWYER NOTE: Arbitration clauses and class action waivers may not be enforceable in all jurisdictions, particularly in the EU. Consider whether to include carve-outs for users in jurisdictions where these provisions are unenforceable. Also verify compliance with state-specific requirements (e.g., California).]
...
*These Terms of Service apply to Evolution Engine version 0.1.x and the codequal.dev website as of the effective date above.*
